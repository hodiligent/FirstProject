...
public class CommentControl {
    ...
    private List<Comment> getComment(){
        ...
        comment.setIcon(
                "http://p1.music.126.net/fQPcNZ7yTMMRkBIobpgiXw==/109951163284896187.jpg?param=50y50");
        comment.setNickName("Notearslefttocry");
        comment.setContent(
                "hello！一转眼四年了！终于等到王者的归来~阿呆的全球屠榜又要开始啦！在此献上我的鸡腿！嘻嘻~");
        comment.setCommentTime("2015年10月23日");
        comment.setLikeNum(82494);
        commens.add(comment);
